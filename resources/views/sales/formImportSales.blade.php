...
@section('breadcrumb')
    <a href="{{route('slipOrder.index')}}">Sales</a>
     &nbsp;/&nbsp;
     Import Data Sales
@stop
...
<div class="panel-body">
    <h3 class="title-hero">Import Data Sales</h3>
    <form role="form" action="/simpanUploadSales" method="POST" class="form-horizontal bordered-row" id="ism_form" enctype="multipart/form-data">
        @csrf
