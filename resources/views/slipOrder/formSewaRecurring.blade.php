      ...
      <div id="page-content" style="min-height: 600px;">
        <div class="container">
          ...
          <div id="page-title">
            ...
            <p>@section('contentheader_description') COSAN CRM @show</p>
              <ol class="breadcrumb">
                ...
                <li class="active"> Recurring @section('breadcrumb') @show </li>
              </ol>
          </div>
                ...
                <div class="col-md-12">
                  <div class="nav-tabs-custom">
                    ...
                    <ul class="nav nav-tabs">
                      <li class="active"><a href="#recurring" data-toggle="tab">Jual Sewa Recurring</a></li>
                    </ul>
                    {{-- tab title end --}}
                        
                    <div class="tab-content">
                      {{-- tab pertama start --}}
                      <div class="active tab-pane" id="recurring">  
                        ...
                        <form action="/slipOrder/simpan" enctype="multipart/form-data" method="POST" id="buat_invoice_sewa">
                          ...
                          <input type="hidden" class="form-control" name="tipe_penjualan" value="SewaRecurring" />				
                          <input type="hidden" name="status_recurring" value="belumRecurring" />				
                          <div class="row">
                            <div class="col-md-6">
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-6">	
                                  <div class="form-group form-group-sm">
                                    <label>Nama Agency<span class="required">*</span></label>   
                                ...
                                <div class="col-md-12">
                                  <div class="form-group form-group-sm">
                                    ...
                                    <select name="id_customer" id="customer_id2" class="form-control" width="100%">
                                      <option value="" disabled selected>-- Pilihan Customer --</option>
                              ...
                              <div class="row">
                                <div class="col-md-12">
                                  <div class="form-group form-group-sm">
                                    ...
                                    <textarea class="form-control" name="alamat_ktp" id="" cols="30" rows="4" v-model="customer2.alamat_ktp"></textarea>  
                                  </div>                                  
                                </div>
                              </div>                                  
                              <div class="row">
                                <div class="col-md-12">
                                  <div class="form-group form-group-sm">
                                    ...
                                    <textarea class="form-control" name="alamat_pemasangan" id="" cols="30" rows="4" v-model="customer2.alamat_pemasangan"></textarea>  
                                  </div>                                      
                                </div>
                              </div>                                  
                              <div class="row">
                            ...
                            <div class="col-md-12">
                              <div class="row">
                                <div class="col-md-6"> 
                                  <div class="row">
                                    <div class="col-md-12">
                                      <h2>Pembayaran Pertama</h2><br>
                                      <div class="form-group form-group-sm">
                                        <label>Pembayaran</label>                           
                                        <select id="pilihanMetodePembayaran" name="metode_pembayaran" class="form-control gampang" onchange="munculBank()">
                                    ...
                                    <div class="nampilinBank" id="tampil">
                                      <div class="col-md-12 output">
                                        <div class="form-group form-group-sm">
                                          <label>Jenis Bank</label> 
                                          <a data-toggle="modal" class="btn btn-primary btn-xs" data-target="#newBankModal"><i class='fa fa-plus'></i> Input bank baru</a>                          
                                          <button type="button" class="btn btn-primary btn-xs" @click="refreshBank()"><i class='fa fa-refresh'></i></button>
                                          <select class='form-control gampang' name="id_bank">
                                    ...
                                    <div class="col-md-12 munculNominal" id="nom">
                                      <div class="form-group form-group-sm">
                                        <label>Nominal Pembayaran</label>                           
                                        <input type="text" class="form-control"name="total_tagihan" value="{{$biaya_sewa->biaya_sewa}}">
                                        <input type="hidden" name="status_pelunasan" value="SewaRecurring">
                                      </div>                                              
                                    </div>
                                  </div>
                                </div>
                                <div class="col-md-6">
                                  <div class="row">
                                    <div class="col-md-12">
                                      <h2>Data Recurring</h2><br>
                                      <div class="form-group form-group-sm">
                                        <label>Kelengkapan Data<span class="required">*</span></label>                           
                                        <select id="recurring_selector" name="kelengkapan_data_recurring" class="form-control">
                                          <option value="" disabled selected>-- Pilihan --</option>
                                          <option value="isi">Data lengkap</option>
                                          <option value="tidak_lengkap">Data Tidak Lengkap </option>
                                        </select>
                                      </div>                                                
                                    </div>
                                    <div class="recurring" id="isi">
                                      <div class="col-md-12 output_recurring">
                                        <div class="form-group form-group-sm">
                                          <label>Nama Pemilik Kartu<span class="required">*</span></label>                           
                                          <input type="text" name="nama_pemilik_kartu_recurring" class="form-control" v-model="customer2.nama_customer" value="">
                                        </div>                                                      
                                      </div>
                                      <div class="col-md-12 output_recurring">
                                        <div class="form-group form-group-sm">
                                          <label>Jenis Bank<span class="required">*</span></label>  
                                          <a data-toggle="modal" class="btn btn-primary btn-xs" data-target="#newBankModal"><i class='fa fa-plus'></i> Input bank baru</a>                          
                                          <button type="button" class="btn btn-primary btn-xs" @click="refreshBank()"><i class='fa fa-refresh'></i></button> 
                                      ...
                                      <div class="col-md-12 output_recurring">
                                        <div class="form-group form-group-sm">
                                          <label>Jenis kartu Kredit<span class="required">*</span></label>                           
                                      ...
                                      <div class="col-md-12 output_recurring">
                                        <div class="form-group form-group-sm">
                                          <label>Masa Kartu Expired<span class="required">*</span></label>                           
                      ...
                      <div class="bg-default content-box text-center pad20A mrg25T">
                          <a class="btn btn-lg btn-primary" onclick="event.preventDefault();  document.getElementById('buat_invoice_sewa').submit(); www();"> Save</a>        
                      </div>
          ...
          <div class="panel-footer">
            ...
            <a class="btn btn-border btn-alt border-primary font-black btn-xs pull-right" href="/slipOrder"> <i class="fa fa-backward"></i> Kembali </a>
          </div>             
