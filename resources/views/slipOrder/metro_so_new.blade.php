    ...
    <meta charset="UTF-8">
      ...
      <style>
        ...
        * {
        ...
        .icon-beli {
          background: url("/icon_cosan/beli.png");
        }

        .icon-sewa {
          background: url("/icon_cosan/sewa.png");
        }

        .icon-sewa_recurring {
          background: url("/icon_cosan/sewarecurring.png");
        }
        ...
        .icon-invoice_recuring {
          background: url("/icon_cosan/sewarecuring.png");
        }
        ...
        .icon-excel {
          background: url("/icon_cosan/excel.png");
        }
                ...
                <div class="panel-body" id="dw">
                  <div class="row">          
                    <div class="col-md-12">
                      {{-- ------------------------------------------------------------------------------- --}}
                      <div class="wrap">                                
                        <a href="{{route('orderSewaRecurring')}}">
                          <div class="metro-huge chat">
                            <div class="icon-sewa_recurring"></div>
                              <span class="label bottom">Buat Slip Order Sewa Recurring</span>
                            </div>
                        </a>
                        <a href="{{route('orderSewaPeriode')}}">
                          <div class="metro-huge chat">
                            <div class="icon-sewa"></div>
                            <span class="label bottom">Buat Slip Order Sewa Periode</span>
                          </div>
                        </a>
                        <a href="{{route('orderJualPutus')}}">
                          <div class="metro-huge chat">
                            <div class="icon-beli"></div>
                            <span class="label bottom">Buat Slip Order Jual Putus</span>
                          </div>
                        </a>                                                       
                        <a href="{{route('getImportSO')}}">
                          <div class="metro-huge chat">
                            <div class="icon-excel"></div>
                            <span class="label bottom">Import file Excel</span>
                          </div>
                        </a>                                                       
                      </div>
                      {{-- ------------------------------------------------------------------------------- --}}
