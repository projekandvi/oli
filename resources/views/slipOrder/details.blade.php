...
@section('breadcrumb')
  <a href="{{route('akunting.index')}}">Slip Order</a>
        ...
        <div class="tab-content">
              ...
              <div class="row">
                <div class="col-md-2">
                  <div class="row">
                    ...
                    <div class="col-md-12">	
                      <label>Team</label>                           
                      <input type="text" class="form-control" value="{{$so->team}}" disabled="true">
                    </div>
                    <div class="col-md-12">	
                      <label>Nama Dealer</label>                           
                      <input type="text" class="form-control" value="{{$so->nama_seller}}" disabled="true">
                    </div>
                    <div class="col-md-12">	
                    ...
                    <div class="col-md-12">	
                      <label>LA Code</label>                           
                      <input type="text" class="form-control" value="{{$so->la_code}}" disabled="true">
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-4 text-center">
                  <div class="tile-box tile-box-alt bg-gradient-9 font-white">
                    <div class="tile-header">  Sisa Tagihan </div>
                      <div class="tile-content-wrapper">
                          <i class="glyph-icon fa fa-money"></i>
                            <div class="tile-content">
                              <span> Rp {{ number_format($so->sisa_tagihan,0,'.','.') }}  
                                <small>
                                  {{-- Amount (
                    ...
                    <tbody>
                      <tr>
                        <td class="text-center">
                          <ol class="text-left">
                            {{-- @foreach ($so->tampung as $item)                            
                                <li>{{$item->nama_barang}}</li>                            
                            @endforeach --}}
                          </ol>
                        </td>                        
                        <td class="text-center">Rp {{ number_format($so->harga,0,'.','.') }}</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
          ...
          <div class="tab-pane" id="payment_history">
            <div class="col-md-12 text-center">
                        <label style="font-size: 20px;">Sisa Tagihan : Rp {{ number_format($so->sisa_tagihan,0,'.','.') }}</label>
                    </div><br><hr>
                ...
                <div class="tab-pane" id="make_payment">
                    <div class="row">
                        ...
                        {!! Form::model($so,['method' => 'post','action' => 'InvoiceController@bayar', 'files' => true, 'class' => 'form-horizontal bordered-row', 'id' => 'ism_form']) !!}
                        <div class="col-md-6">
                            <div class="col-md-12">
              ...
              <div class="tab-pane" id="timeline{{$so->id}}">
