        ...
        <div class="container">
          ...
          <div class="panel">
                ...
                <div class="col-md-12">
                  <div class="nav-tabs-custom">
                    ...
                    <ul class="nav nav-tabs">
                      <li class="active"><a href="#beli_putus" data-toggle="tab">Jual Beli Putus</a></li>
                    </ul>
                    {{-- tab title end --}}                        
                    <div class="tab-content">
                      ...
                      <div class="active tab-pane" id="beli_putus">  
                        ...
                        <form action="/slipOrder/simpan" enctype="multipart/form-data" method="POST" id="buat_invoice_jual_putus">
                          @csrf
                          <input type="hidden" name="id_staf" value="{{Auth::user()->id}}" />				
                          <input type="hidden" name="status_barang" value="Terjual" />
                          <input type="hidden" class="form-control" name="tipe_penjualan" value="Putus" />				
                          <div class="row">
                              <div class="col-md-6">
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-6">	
                                  <div class="form-group form-group-sm">
                                    ...
                                    <a data-toggle="modal" class="btn btn-primary btn-xs" data-target="#newSales"><i class='fa fa-plus'></i> Agency</a> 
                                    <button type="button" class="btn btn-primary btn-xs" @click="refreshSales()"><i class='fa fa-refresh'></i></button>                      
                                    <select name="sales" class="form-control" id="agency_id">
                              ...
                              <div class="row">
                                <div class="col-lg-12">
                                  ...
                                  <div class="form-group form-group-sm">
                                      ...
                                      <select id="barang_id" class="form-control" v-model="item.id_barang">
                                  ...
                                  <div class="form-group form-group-sm">
                                      <label>Harga</label>
                                      <input v-model="item.harga2" class="form-control" value="">
                                  </div>
                                  <div class="form-group form-group-sm">
                                      <label>Qty</label>
                            ...
                            <div class="col-md-12">
                              ...
                              <div class="col-md-12">
                                <div class="form-group">
                                   <h3><label>Layanan Service</label></h3>                          
                                  <div class="form-check">
                                      <input type="checkbox" class="form-check-input" value="12" name="layanan_service">
                                      <label class="form-check-label" for="exampleCheck1">1 Tahun</label> &nbsp;
                                      <input type="checkbox" class="form-check-input" value="60" name="layanan_service">
                                      <label class="form-check-label" for="exampleCheck1">5 Tahun</label>
                                  </div>
                                </div>                                     
                              </div>
                              {{-- <h2>CART</h2> --}}
                                  ...
                                  <div class="collapse" id="pembayaran2">
                                    <div class="form-group form-group-sm">
                                      ...
                                      <div class="form-group form-group-sm">
                                        <label>Jenis Bank</label>                           
                                        <select class='form-control gampang' name="jenis_bank[]">
                                          <option value="" disabled="disabled" selected="selected">-- Pilihan Bank --</option>
                                          <option v-for='data in daftarBank' v-bind:value='data.kode_bank'>@{{ data.nama_bank }}</option>
                                        </select>
                                      </div>
                                      <div class="form-group form-group-sm">
                                    ...
                                    <input type="text" class="form-control" name="sisa_tagihan" v-model="details.total - adi.sisa1 - adi.sisa2 - adi.sisa3 - adi.sisa4 - adi.sisa5" value="">
                                  </div>
                                  </div>
                                <div class="col-md-12">
                                  <div class="form-group form-group-sm">
                        ...
                        <div class="bg-default content-box text-center pad20A mrg25T">
                          <a class="btn btn-lg btn-primary" onclick="event.preventDefault();  document.getElementById('buat_invoice_jual_putus').submit();"> Save</a>        
                        </div>
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              ...
                              <h4 class="modal-title" id="myModalLabel">Form Input VP / GM Baru</h4>
                            </div>
                            <div class="modal-body">
                              <div class="form-group" style="margin-bottom: 40px;">
                                <label class="col-sm-4" style="text-align: left;">Nama VP / GM</label>
                                <div class="col-sm-8">
            ...
            <div class="panel-footer">
              ...
              <a class="btn btn-border btn-alt border-primary font-black btn-xs pull-right" href="/slipOrder"> <i class="fa fa-backward"></i> {{trans('back')}} </a>
            </div>                                  
