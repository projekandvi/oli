                      ...
                      <div class="col-md-12">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12 animated headShake">                      
                          <div class="tile-box tile-box-alt bg-blue font-white">
                            <div class="tile-header">Penjualan Sistem Sewa</div>
                            <div class="tile-content-wrapper">
                              <i class="glyph-icon fa fa-ship"></i>
                              <div class="tile-content">
                              <span> {{$sewa}} Invoices<small>	Amount ( Rp {{ number_format($totalTransaksiSewa,0,'.','.') }}  )</small>	</span>
                              </div>
                            </div>
                            <a href="/slipOrderSewa" class="tile-footer tooltip-button" data-placement="bottom" title="" data-original-title="Lihat Detail"> Lihat Detail  <i class="glyph-icon icon-arrow-right"></i> </a>
                          </div>                      
                        </div> 	
                        <!--Total cash received today-->
                        <div class="col-md-4 col-sm-6 col-xs-12 animated headShake">
                          <div class="tile-box tile-box-alt bg-gradient-9 font-white">
                            <div class="tile-header">Penjualan Sistem Jual Putus</div>
                              <div class="tile-content-wrapper">
                              <i class="glyph-icon fa fa-money"></i>
                                <div class="tile-content">
                                <span> {{$putus}} Invoices <small>	Amount ( Rp {{ number_format($totalTransaksiPutus,0,'.','.') }} )</small></span>
                              </div>
                              </div>
                              <a href="slipOrderPutus" class="tile-footer tooltip-button" data-placement="bottom" title="" data-original-title="Lihat Detail">  Lihat Detail  <i class="glyph-icon icon-arrow-right"></i> </a>
                            </div>
                        </div> <!-- /.col -->
