...
@section('title')
	Slip Order Sewa Recurring tanggal 10
@stop

@section('contentheader')
Daftar Slip Order Sewa Recurring tanggal 10
@stop
...
<div class="panel-heading">		
	...
	@if(count(Request::input()))
		<span class="pull-right">	
			<a class="btn btn-default btn-alt btn-xs" href="{{ action('SlipOrderController@getIndexSewaRecurring10') }}"><i class="fa fa-eraser"></i> clear</a>
