      ...
      <!--Inventories start-->
				<div class="col-md-4 col-sm-6 col-xs-12 animated headShake batasan">			
				  <div class="tile-box tile-box-alt bg-blue font-white">
					  ...
					  <a href="#" class="tile-footer tooltip-button" data-placement="bottom" title="" data-original-title="View Inventories"> View Inventories  <i class="glyph-icon icon-arrow-right"></i> </a>
				  </div>
      ...
      <!--Slip Order start-->
				<div class="col-md-4 col-sm-6 col-xs-12 animated headShake batasan">			
				  <div class="tile-box tile-box-alt bg-blue font-white">
					  ...
					  <a href="#" class="tile-footer tooltip-button" data-placement="bottom" title="" data-original-title="View Slip Order"> View Slip Order  <i class="glyph-icon icon-arrow-right"></i> </a>
				  </div>
      ...
      <!--Akunting start-->
				<div class="col-md-4 col-sm-6 col-xs-12 animated headShake batasan">			
				  <div class="tile-box tile-box-alt bg-blue font-white">
					  ...
					  <a href="#" class="tile-footer tooltip-button" data-placement="bottom" title="" data-original-title="View Akunting"> View Akunting  <i class="glyph-icon icon-arrow-right"></i> </a>
				  </div>
      ...
      <!--Tiket start-->
				<div class="col-md-4 col-sm-6 col-xs-12 animated headShake batasan">			
				  <div class="tile-box tile-box-alt bg-blue font-white">
					  ...
					  <a href="#" class="tile-footer tooltip-button" data-placement="bottom" title="" data-original-title="View Tiket"> View Tiket  <i class="glyph-icon icon-arrow-right"></i> </a>
				  </div>
      ...
      <!--Monitoring Instalasi start-->
				<div class="col-md-4 col-sm-6 col-xs-12 animated headShake batasan">			
				  <div class="tile-box tile-box-alt bg-blue font-white">
					  ...
					  <a href="#" class="tile-footer tooltip-button" data-placement="bottom" title="" data-original-title="View Monitoring Instalasi"> View Monitoring Instalasi  <i class="glyph-icon icon-arrow-right"></i> </a>
				  </div>
