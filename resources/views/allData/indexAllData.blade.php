	...
	<table class="table table-bordered">
		<thead class="bg-gradient-1">
			<tr>
				...
				<td class="text-center font-white">TANGGAL PENJUALAN</td>
				<td class="text-center font-white">TANGGAL UPGRADE</td>
				<td class="text-center font-white">NOMOR SO</td>
				<td class="text-center font-white">NAMA CUSTOMER</td>
				<td class="text-center font-white">TANGGAL LAHIR</td>
				<td class="text-center font-white">KEWARGANEGARAAN</td>
				<td class="text-center font-white">ALAMAT</td>
				<td class="text-center font-white">NO TELEPON</td>
				<td class="text-center font-white">HANDPHONE (1)</td>
				<td class="text-center font-white">HANDPHONE (2)</td>
				<td class="text-center font-white">NO KTP</td>
				<td class="text-center font-white">MANAGER</td>
				<td class="text-center font-white">SALES</td>
				<td class="text-center font-white">CRC CODE</td>
				<td class="text-center font-white">INVESTOR CODE</td>
				<td class="text-center font-white">LOKASI PEMBELIAN</td>
				<td class="text-center font-white">KECAMATAN</td>
				<td class="text-center font-white">KOTA / KABUPATEN</td>
				<td class="text-center font-white">PROVINSI</td>
				<td class="text-center font-white">MESIN NEW / UP / EXT</td>
				<td class="text-center font-white">MESIN TERPASANG</td>
				<td class="text-center font-white">FILTER TAMBAHAN</td>
				<td class="text-center font-white">PROGRAM</td>
				<td class="text-center font-white">NAMA PADA KARTU</td>
				<td class="text-center font-white">KARTU BANK</td>
				<td class="text-center font-white">NO KARTU</td>
				<td class="text-center font-white">TANGGAL AUTODEBIT</td>
				<td class="text-center font-white">TTD SURAT KUASA PENDEBITAN</td>
				<td class="text-center font-white">FREE SERVICE</td>
				<td class="text-center font-white">PEMASANGAN - TGL</td>
				<td class="text-center font-white">PEMASANGAN - TEKNISI</td>
				<td class="text-center font-white">PEMASANGAN - NO. INSTALASI</td>
				<td class="text-center font-white">PEMASANGAN - SUMBER</td>
				<td class="text-center font-white">PEMASANGAN - SEBELUM - TDS</td>
				<td class="text-center font-white">PEMASANGAN - HASIL - TDS LV.1</td>
				<td class="text-center font-white">PEMASANGAN - HASIL - TDS LV.2</td>
				<td class="text-center font-white">PEMASANGAN - HASIL - TDS LV.3</td>
				<td class="text-center font-white">PEMASANGAN - HASIL - TDS LV.4</td>
				<td class="text-center font-white">PEMASANGAN - HASIL - TDS LV.5</td>
				<td class="text-center font-white">PEMASANGAN - HASIL - TDS LV.6</td>
				<td class="text-center font-white">PEMASANGAN - SEBELUM - PH</td>
				<td class="text-center font-white">PEMASANGAN - HASIL - PH LV.1</td>
				<td class="text-center font-white">PEMASANGAN - HASIL - PH LV.2</td>
				<td class="text-center font-white">PEMASANGAN - HASIL - PH LV.3</td>
				<td class="text-center font-white">PEMASANGAN - HASIL - PH LV.4</td>
				<td class="text-center font-white">PEMASANGAN - HASIL - PH LV.5</td>
				<td class="text-center font-white">PEMASANGAN - HASIL - PH LV.6</td>
				<td class="text-center font-white">REMARKS</td>
				<td class="text-center font-white">HARGA</td>
				<td class="text-center font-white">DP</td>
				<td class="text-center font-white">PELUNASAN / CICILAN</td>
				<td class="text-center font-white">SISA</td>
				<td class="text-center font-white">SURAT PERJANJIAN</td>
				<td class="text-center font-white">STATUS SURAT PERJANJIAN - DIKELUARKAN</td>
				<td class="text-center font-white">STATUS SURAT PERJANJIAN - DITANDATANGANI</td>
				<td class="text-center font-white">KELENGKAPAN</td>
				<td class="text-center font-white">STATUS SEWA</td>
				<td class="text-center font-white">STATUS PASANG</td>
				<td class="text-center font-white">TANGGAL TARIK BARANG</td>
				<td class="text-center font-white">HABIS KONTRAK</td>
				<td class="text-center font-white">NO KARTU CUSTOMER</td>
				<td class="text-center font-white">BIAYA TRANSPORTASI</td>
				<td class="text-center font-white">SERVICE 1 - JADWAL</td>
				<td class="text-center font-white">SERVICE 1 - TEKNISI</td>
				<td class="text-center font-white">SERVICE 1 - TINDAKAN</td>
				<td class="text-center font-white">SERVICE 1 - BIAYA KUNJUNGAN</td>
				<td class="text-center font-white">SERVICE 1 - SUMBER</td>
				<td class="text-center font-white">SERVICE 1 - SEBELUM - TDS</td>
				<td class="text-center font-white">SERVICE 1 - HASIL - TDS LV.1</td>
				<td class="text-center font-white">SERVICE 1 - HASIL - TDS LV.2</td>
				<td class="text-center font-white">SERVICE 1 - HASIL - TDS LV.3</td>
				<td class="text-center font-white">SERVICE 1 - HASIL - TDS LV.4</td>
				<td class="text-center font-white">SERVICE 1 - HASIL - TDS LV.5</td>
				<td class="text-center font-white">SERVICE 1 - HASIL - TDS LV.6</td>
				<td class="text-center font-white">SERVICE 1 - SEBELUM - PH</td>
				<td class="text-center font-white">SERVICE 1 - HASIL - PH LV.1</td>
				<td class="text-center font-white">SERVICE 1 - HASIL - PH LV.2</td>
				<td class="text-center font-white">SERVICE 1 - HASIL - PH LV.3</td>
				<td class="text-center font-white">SERVICE 1 - HASIL - PH LV.4</td>
				<td class="text-center font-white">SERVICE 1 - HASIL - PH LV.5</td>
				<td class="text-center font-white">SERVICE 1 - HASIL - PH LV.6</td>
		...
		<tbody>
			@foreach($allData as $SO)	
				...
				<tr>			
					...
					<td class="text-center">
						{!! Form::open(['url' => '/allDataDetail','method' => 'post','class' => 'form-horizontal','id' => 'ism_form']) !!}
							<input type="hidden" value="{{$SO->id_slip_order}}" name="id_slip_order">
							<input class="btn btn-lg btn-primary" type="submit" id="submitButton" value="Proses Verifikasi">
						{!! Form::close() !!}
					</td>		
