                        ...
                        @if (Auth::user()->status === 'administrator' || Auth::user()->status === 'DIRECTOR' || Auth::user()->status === 'BOTH OF DIRECTOR' || Auth::user()->status === 'OPERATIONAL MANAGER')
                          <a href="{{route('lead.index')}}">
                            <div class="metro-big calendar">
                                ...
                                <span class="label bottom">Leads</span>
                            </div>
                          </a>
                          ...
                          <a href="{{route('customer.index')}}">
                              <div class="metro-big calendar">
                                  ...
                                  <span class="label bottom">Customer</span>
                              </div>
                          </a>

                          <a href="{{route('barang.index')}}">
                              <div class="metro-big calendar">
                                  <div class="icon-inventori"></div>
                                  <span class="label bottom">Inventori</span>
                              </div>
                          </a>
                          <a href="{{route('slipOrder.index')}}">
                              <div class="metro-big calendar">
                                  <div class="icon-invoice"></div>
                                  <span class="label bottom">Slip Order</span>
                              </div>
                          </a>
                    
                          <a href="/akunting">
                              <div class="metro-big calendar">
                                  <div class="icon-akunting"></div>
                                  <span class="label bottom">Akunting</span>
                              </div>
                          </a>
                          <a href="/tiket">
                              <div class="metro-big calendar">
                                  <div class="icon-tiket"></div>
                                  <span class="label bottom">Tiket</span>
                              </div>
                          </a>
                          <a href="/instalasi">
                              <div class="metro-big calendar">
                                  <div class="icon-instalasi"></div>
                                  <span class="label bottom">Monitoring Instalasi</span>
                              </div>
                          </a>
                          <a href="/delivery">
                              <div class="metro-big calendar">
                                  <div class="icon-delivery"></div>
                                  <span class="label bottom">Monitoring Delivery Order</span>
                              </div>
                          </a>
                          ...
                          <a href="/maintenance">
                              <div class="metro-big calendar">
                                  ...
                                  <span class="label bottom">Monitoring Maintenance</span>
                              </div>
                          </a> 
