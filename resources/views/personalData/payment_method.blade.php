          ...
          <div class="row">
            ...
            <div class="col-lg-9">
              <div class="row">
                ...
                <div class="col-lg-9">
                    <h5 class="mb-4">OVO, GOPAY, LinkAja, DANA</h5>
                    <form class="form-cc">
                      <div class="row d-flex align-items-center">
                        <div class="col-sm-3"><img src="{{ asset('/frontend/img/ovo@4x.png') }}" class="img-fluid" alt=""></div>
                        <div class="col-sm-3"><img src="{{ asset('/frontend/img/gopay@4x.png') }}" class="img-fluid" alt=""></div>
                        <div class="col-sm-3"><img src="{{ asset('/frontend/img/linkaja@4x.png') }}" class="img-fluid" alt=""></div>
                        <div class="col-sm-3"><img src="{{ asset('/frontend/img/dana@4x.png') }}" class="img-fluid" alt=""></div>
                      </div>
