            ...
            <div class="col-lg-9">
              <div class="row mb-3 ed-container menu-ed d-flex align-items-center">
                ...
                <div class="col-lg-1 text-right">
                  <button class="btn btn-back next" onclick="location.href='/security';"><i class="fas fa-angle-right"></i></button>
                </div>
              </div>
              <div class="row mb-3 ed-container menu-ed  d-flex align-items-center">
                <div class="col-lg-11">
                ...
                <div class="col-lg-1 text-right">
                  <button class="btn btn-back next" onclick="location.href='/payment';"><i class="fas fa-angle-right"></i></button>
                </div>
              </div>
            </div>
          </div>
