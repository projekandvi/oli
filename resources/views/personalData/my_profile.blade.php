              ...
              <div class="row">
                <div class="col-lg-2 text-center">
                  ...
                  <div class="form-group form-childstage">
                    ...
                    <input type="email" class="form-control" id="inputEmail3" value="{{$dataUser->educational_stage}}" disabled>
                  </div>
                  ...
                  <form class="myprofile">
                    <div class="form-group row">
                      <div class="col-lg-8">
                        <div class="row">
                          ...
                          <div class="col-sm-9">
                          <input type="email" class="form-control" id="inputEmail3" value="{{$dataUser->child_fullname}}" disabled>
                          </div>
                        </div>
                      </div>
                      <div class="col-lg-4">
                          ...
                          <div class="radio-gender col-sm-8 d-flex justify-content-center">
                            ...
                            @else
                              <div class="form-check form-check-inline mx-3" id="female">
                                <input class="form-check-input" type="radio" name="radioGender" id="inlineRadio2" value="option2" checked>
                    ...
                    <div class="form-group row">
                      <div class="col-lg-6">
                        <div class="row">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control" id="inputFullName" name="inputFullName" value="{{$dataUser->child_username}}" disabled>
                          </div>
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="row">
                          ...
                          <div class="col-sm-8">
                            <input type="tel" class="form-control" id="inputPhone" name="inputPhone" value="{{$dataUser->parent_phone}}" disabled>
                          </div> 
                        </div>
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-lg-6">
                        <div class="row">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control" id="inputBio" name="inputBio" value="{{$dataUser->bio}}" disabled>
                          </div>
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="row">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control" id="inputBirthday" name="inputBirthday" value="{{$dataUser->child_birthday}}" disabled>
                          </div> 
                        </div>
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-lg-6">
                        <div class="row">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control" id="inputHobby" name="inputHobby" value="{{$dataUser->hobby}}" disabled>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-lg-12">
                        <div class="row">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputAddress" name="inputAddress" value="{{$dataUser->address}}" disabled>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-lg-6">
                        <div class="row">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control" id="inputCountry" name="inputCountry" value="{{$dataUser->country}}" disabled>
                          </div>
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="row">
                          ...
                          <div class="col-sm-7">
                            <input type="text" class="form-control" id="inputProvince" name="inputProvince" value="{{$dataUser->province}}" disabled>
                          </div> 
                        </div>
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-lg-6">
                        <div class="row">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control" id="inputCity" name="inputCity" value="{{$dataUser->city}}" disabled>
                          </div>
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="row">
                          ...
                          <div class="col-sm-7">
                            <input type="text" class="form-control" id="inputSubdis" name="inputSubdis" value="{{$dataUser->sub_district}}" disabled>
                          </div> 
                        </div>
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-lg-6">
                        <div class="row">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control" id="inputDistrict" name="inputDistrict" value="{{$dataUser->district}}" disabled>
                          </div>
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="row">
                          ...
                          <div class="col-sm-7">
                            <input type="number" class="form-control" id="inputPostcode" name="inputPostcode" value="{{$dataUser->postal_code}}" disabled>
                          </div> 
                        </div>
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-sm-10">
                        ...
                        <a href="/myProfileEdit/{{$dataUser->id}}" class="btn btn-success px-5">Edit Profile</a>
                      </div>
                    </div>
                  </form>
                </div>
