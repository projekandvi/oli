          ...
          <div class="col-sm-8">
                    ...
                    <div class="col-sm-6">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td class="text-left" style="border: none;">: <small>{{$so->salesnya->agency_code}}</small></td>
                            </tr>
                            <tr>
                                <td class="text-left" style="border: none;">CRC Code</td>
                                <td class="text-left" style="border: none;">: <small>{{$so->crc_code}}</small></td>
                            </tr>
                        </table>
                    </div>
                    <div class="col-sm-12">
                        <table class="table table-bordered">
                            ...
                            <tbody>	
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><small>{{$so->periode_sewa}} Bulan</small></td>                    
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>	          	
                                <tr>
                                    <td> <small>{{$so->periode_sewa}} Bulan</small></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
	       ...
	       <div class="col-sm-4">
	            <table class="table">
                    ...
                    <tr>
                        <td class="text-left" style="border: none;">Remark</td>
                        <td class="text-left" style="border: none;">: {{$so->remark}}</td>
                    </tr>
	            </table>
	        </div>
	      <!-- /.col -->
