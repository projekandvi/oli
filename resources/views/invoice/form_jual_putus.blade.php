    ...
    {{-- {!! Form::open(['route'=> ['slipOrder.post', $invoice], 'method'=>'post', 'files' => true, 'class' => 'form-horizontal bordered-row', 'id' => 'ism_form']) !!} --}}
    <form action="/slipOrder/new" enctype="multipart/form-data" method="POST" id="buat_invoice">
        @csrf
            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <select name="id_customer" id="product_id" class="form-control pakaiselec2" width="100%">
...
<div class="bg-default content-box text-center pad20A mrg25T">
    ...
    <a class="btn btn-lg btn-primary" onclick="event.preventDefault();  document.getElementById('buat_invoice').submit();"> Save</a>        
</div>