...
@section('breadcrumb')
    <a href="{{route('slipOrder.index')}}">Pembayaran</a>
     &nbsp;/&nbsp;
     Import Data Pembayaran
@stop
...
<div class="panel-body">
    <h3 class="title-hero">Import Data Pembayaran</h3>
    <form role="form" action="/simpanUploadPembayaran" method="POST" class="form-horizontal bordered-row" id="ism_form" enctype="multipart/form-data">
        @csrf
