...
class CartController extends Controller
{
    public function index()
    {
        ...
        // {
        //     // $tampung['id'] =  $item->id;      
        //     $tampung['id_transaksi'] =  $nomor_otomatis;      
        //     $tampung['name'] =  $item->name;      
        ...
        if(request()->ajax()) {
            ...
            // return view('cart');
            return view('cart', compact('invoice','nomor_otomatis','tanggal_otomatis','customers','barangs'));
        }
    }
    ...
    public function add() {
        ...
        $item = \Cart::session($userId)->add($id_barang, $nama_barang, $harga, $qty, $customAttributes);
